...
from 딥러닝.project_reference.src.training.train import ModelA, ModelB  # 학습할 모델 클래스를 임포트
from 딥러닝.project_reference.src.data.data_loader import load_data, preprocess_data  # 데이터 로딩 및 전처리 함수 임포트
